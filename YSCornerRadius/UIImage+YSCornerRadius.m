...
@implementation UIImage (YSCornerRadius)

- (UIImage *)ys_imageByRoundCornerRadius:(CGFloat)radius {
    return [self ys_imageByRoundCornerRadius:radius borderWidth:0 borderColor:nil];
}

- (UIImage *)ys_imageByRoundCornerRadius:(CGFloat)radius
                             borderWidth:(CGFloat)borderWidth
                             borderColor:(UIColor *)borderColor {
    return [self ys_imageByRoundCornerRadius:radius corners:UIRectCornerAllCorners borderWidth:borderWidth borderColor:borderColor];
}
...
+ (UIImage *)ys_imageWithColor:(UIColor *)color {
    return [self ys_imageWithColor:color size:CGSizeMake(1, 1)];
}
